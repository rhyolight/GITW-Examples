                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="name"><g:message code="bar.name.label" default="Name" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                    <label for="foo"><g:message code="bar.foo.label" default="Foo" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: barInstance, field: 'foo', 'errors')}">
                                    <g:select name="foo.id" from="${Foo.list()}" optionKey="id" value="${barInstance?.foo?.id}"  />
                                </td>
                            </tr>
