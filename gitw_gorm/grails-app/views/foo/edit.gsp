                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:fooInstance,field:'links','errors')}">
...
<g:link controller="fooBarLink" params="['foo.id':fooInstance?.id]" action="create">Add FooBarLink</g:link>
